...
<body>
  <div class="page page-zero font-white">
    <table style="font-size: 56px;">
      <tr>
        <td></td>
        <td style="padding: 22rem 12rem 0rem 0rem; vertical-align: top important!;">
          Selemat belajar membaca <br>
          {{$data->name}} sayang.. <br>
          Peluk cium dari {{$data->mother_name}} & {{$data->father_name}} :)
        </td>
      </tr>
    </table>
  </div>

  <div class="page page-about font-white">
  </div>

  <div class="page page-title font-white">
  </div>
  ...
  <div class="page page-3 font-black">
  ...
  <div class="page page-6 font-black">
    <table style="font-size: 54px;">
      <tr>
        <td></td>
